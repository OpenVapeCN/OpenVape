...
- 支持 Minecraft 1.7.10 Forge、1.7.10 Vanilla、1.8.9 Forge、1.8.9 Vanilla、1.12.2 Forge、1.12.2 Vanilla、1.21.11 Forge 和 26.2 Forge；
...
请等待游戏进入主菜单，确认使用 64 位 JVM，并核对所选 PID、游戏版本和运行环境。支持 1.7.10、1.8.9 和 1.12.2 Vanilla，Fabric 不受支持。不要向标题相似的启动器辅助 JVM 或其他 Java 程序注入。
...
VapeV4 支持 1.7.10、1.8.9 和 1.12.2 Vanilla，但不支持 Fabric。

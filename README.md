...
请等待游戏进入主菜单，确认使用 64 位 JVM，并核对所选 PID、游戏版本和运行环境。支持 1.7.10、1.8.9、1.12.2、1.21.11 和 26.2 Vanilla，以及 1.21.11/26.2 Fabric。不要向标题相似的启动器辅助 JVM 或其他 Java 程序注入。
...
VapeV4 支持 1.7.10、1.8.9、1.12.2、1.21.11 和 26.2 Vanilla，以及 1.21.11/26.2 Fabric。其他 Fabric 版本不在当前支持范围。
...
Minecraft 1.16.5 及其他未列出的 1.16+ 版本兼容性仍不佳；1.21.11 Forge 请使用已验证的 Forge 61.0.8，1.21.11 Fabric 请使用 Fabric Loader 0.19.3，26.2 Forge 请使用已验证的 Forge 65.1.0，26.2 Fabric 请使用 Fabric Loader 0.19.3。
